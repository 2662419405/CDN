...
!function(e, t) {
    ...
    , function(e, t) {
        ...
        function weibo(str) {
          return "<img class='emoji weibo' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0/img/weibo/" + str + ".png'>";
        }
        e.exports = {
            aru25: aru('25'),
            aru39: aru('39'),
            ...
            aru147: aru('147'),
            aru148: aru('148'),
            weibodog7: weibo('dog7'),
            weibodog3: weibo('dog3'),
            weibodog8: weibo('dog8'),
            weibodog9: weibo('dog9'),
            weibodog13: weibo('dog13'),
            weibodog15: weibo('dog15'),
            weibo: weibo('dog7'),
            weibo: weibo('dog7'),
            weibo: weibo('dog7'),
            weibo: weibo('dog7'),
